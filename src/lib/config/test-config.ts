...
import { getConfig, getTypedConfig, hasConfig, validateRequiredConfig } from './index'
...
const templateSubject = getConfig<string>('email.templates.projectRequest.subject')

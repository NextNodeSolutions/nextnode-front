	...
	<DialogPortal>
		...
		<DialogPrimitive.Content
			...
			className={cn(
				...
				// Custom modal sizing for ModalContainer
				'[&[data-modal-size="custom"]]:sm:w-[var(--modal-width)] [&[data-modal-size="custom"]]:sm:max-w-[var(--modal-max-width)]',
				className,
			)}
			{...props}
		>
			{children}
			<DialogPrimitive.Close className="btn-icon focus:ring-ring absolute top-2 right-2 focus:ring-2 focus:ring-offset-2 focus:outline-none">
				<X className="h-5 w-5" />

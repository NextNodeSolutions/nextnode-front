...
export const StepCardFooter = ({
	...
	return (
		<div className="flex h-[var(--card-footer-height)] flex-col justify-end">
			{showStepLabel && (
				<div className="mb-1">
					<span className="text-xs font-medium tracking-wider whitespace-nowrap text-gray-500 uppercase">
						{stepLabel} {number}
					</span>
				</div>
			)}
			...
			<div className="flex items-center">
				...
				<span className="ml-1 text-xs font-medium text-blue-600 opacity-0 transition-all duration-300 group-hover:translate-x-1 group-hover:opacity-100">
					&gt;
				</span>
			</div>
		</div>
